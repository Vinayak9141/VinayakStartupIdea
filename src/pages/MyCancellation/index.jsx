...
export default function MyCancellationPage() {
  return (
    <>
      ...
      <div className="flex flex-col w-full gap-[87px] md:gap-[65px] sm:gap-[43px] bg-white-A700">
        {/* <Header /> */}
        <div className="w-full mx-auto md:p-5 max-w-[1171px]">
          <div className="flex flex-col items-start gap-[60px] sm:gap-[30px]">
            {/* <div className="flex">
              <Text size="s" as="p" className="self-end !text-black-900_01">
                My Orders
              </Text>
            </div> */}
            ...
            {/* <div className="flex md:flex-col self-stretch justify-center items-center gap-6 p-[27px] sm:p-5 bg-gray-100 rounded">
              <div className="w-full p-[35px] my-[7px] md:p-5 bg-white-A700">
                <Img
                  src="http://localhost:3001/images/img_curology_j7pkvqrtusm_unsplash.png"
                  alt="curology_one"
              ...
              <div className="w-full p-3.5 md:p-5 bg-white-A700">
                <Img
                  src="http://localhost:3001/images/img_image_78.png"
                  alt="imageseventyeig"
              ...
              <div className="w-full p-[22px] md:p-5 bg-white-A700">
                <Img
                  src="http://localhost:3001/images/img_image_79.png"
                  alt="imageseventynin"
              ...
              <div className="w-full p-[9px] md:p-5 bg-white-A700">
                <Img
                  src="http://localhost:3001/images/img_image_80.png"
                  alt="imageeighty_one"
              ...
              <div className="w-full p-[17px] md:p-5 bg-white-A700">
                <Img
                  src="http://localhost:3001/images/img_image_81.png"
                  alt="imageeightyone"
            ...
            <Text
              size="lg"
              as="p"
              className="!text-black-900_01 !font-normal pt-10"
            >
              Cancel Order
            </Text>
  ...
  "
      ...
      {/* <Button className="flex items-center justify-center h-[56px] mt-[60px] px-[35px] sm:px-5 text-gray-50 text-center text-base font-medium bg-red-600 min-w-[383px] rounded">
        Cancel the Checked Item
      </Button> */}
      <div className="items-center justify-center pt-8 pl-[550px]">
        <Button
